module lobster_addr::lobster_token {
    ...
    #[test(producer = @0x123)]
    public entry fun test_create_lobster_token(producer: signer) acquires TokenRegistry {
    ...
    public fun test_predefined_data() {
        ...
        assert!(sustainability_score == 85, 7);
    }
    ...
    public entry fun test_view_functions(producer: signer) acquires TokenRegistry, LobsterToken {
        ...
        // Test view functions
        let (_token_id, token_species, token_quantity, token_price, token_value, _token_status) = get_token_info(@0x123);
