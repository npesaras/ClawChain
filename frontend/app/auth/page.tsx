            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Connect directly with restaurants and tokenize your premium lobster catches
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>• Connect directly with premium restaurants</li>
                    <li>• Tokenize your lobster catches for transparency</li>
                    <li>• Increase revenue through direct sourcing</li>
                    <li>• Build reputation with quality certifications</li>
                  </ul>
                </div>
                <div className="space-y-2">
